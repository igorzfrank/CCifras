...
const reverseMajorChordsMap = Object.fromEntries(
  Object.entries(majorChordsMap).map(([key, value]) => [value, key])
);
const reverseMinorChordsMap = Object.fromEntries(
  Object.entries(minorChordsMap).map(([key, value]) => [value, key])
);
